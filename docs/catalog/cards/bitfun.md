...
| HOOK high: i18n placeholder strings mentioning `npx`/`npm install -g @openai/codex` | Locale text shown to users as hints. Dismissed. | apps/app equivalents in BitFun: src/web-ui locales; session-page.tsx:669 |
