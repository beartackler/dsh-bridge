...
export function dshHomeDir(home = homeDir()) {
...
export function profilePatchPath(profile, dshHome = dshHomeDir()) {
...
export function profilePackageJsonPath(profile, dshHome = dshHomeDir()) {
...
export function geminiOauthCredsPath(home = homeDir()) {
 ...
 */
export function opencodeAuthPath(home = homeDir()) {
...
export function dshEnvPath(dshHome = dshHomeDir()) {
 ...
 */
export function probeJsonSource(path, requiredKeys) {
    let stats;
    try {
 ...
 */
export function probeEnvVar(name, env = process.env) {
