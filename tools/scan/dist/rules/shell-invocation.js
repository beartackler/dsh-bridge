...
export const shellInvocationRule = {
    id: "shell-invocation",
    family: "EXEC",
    severity: "high",
    version: "2026.08.3",
    description: "Detects shell-mediated execution shapes: PowerShell -enc/-Command, composed `sh -c` command strings, cmd.exe /c | /k, spawn options { shell: true }, and macOS osascript -e. Array-argv spawns of fixed binaries stay quiet.",
...
//# sourceMappingURL=shell-invocation.js.map