...
export const credentialCliHarvestRule: Rule = {
  id: "credential-cli-harvest",
  family: "CRED",
  severity: "high",
  version: "2026.08.3",
  description:
    "Detects credential access performed through subprocesses and shell commands: `gh auth token` identity adoption, printenv/env dumps, sshpass inline passwords, and cat over .env-style secret files.",
